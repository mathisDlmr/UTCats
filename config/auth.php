...
return [
    ...
    'oauth' => [
        ...
        'redirect_uri' => env('OAUTH_REDIRECT_URI', env('BASE_URL').'utcats/callback'),
        ...
        'owner_assos_url' => env('OAUTH_RESOURCE_OWNER_ASSOS', 'https://auth.assos.utc.fr/api/user/associations/current'),
